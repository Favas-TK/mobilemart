...
class _AddMemoryCardState extends State<AddMemoryCard> {
  ...
  TextEditingController memoryCardName = TextEditingController();

  TextEditingController memoryCardPrice = TextEditingController();

  TextEditingController memoryCardDescription = TextEditingController();

  TextEditingController memoryCardCount = TextEditingController();
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomTextFieldWidget(
                      ...
                      controller: memoryCardName,
                    ),
                    space10,
                    CustomTextFieldWidget(
                      controller: memoryCardDescription,
                      hintText: 'Enter memoryCard Description',
                    ),
                    space10,
                    CustomTextFieldWidget(
                      controller: memoryCardPrice,
                      hintText: 'Enter memoryCard Price',
                    ),
                    space10,
                    CustomTextFieldWidget(
                      controller: memoryCardCount,
                      hintText: 'Enter memoryCard count',
                    ),
                    space10,
                    Container(
                            ...
                            child: CustomElevatedBtnWidget(
                              ...
                              onpressed: () => itemDetails.add(
                                AddDetailEvent(
                                  ...
                                  price: memoryCardPrice.text,
                                  count: memoryCardCount.text,
                                ),
                              ),
                              btnColor: blulight,
                              btnTextColor: white,
