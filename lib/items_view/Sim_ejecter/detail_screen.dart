...
class EjecterDetailScreen extends StatefulWidget {
  EjecterDetailScreen({
    super.key,
  ...
  @override
  State<EjecterDetailScreen> createState() => _EjecterDetailScreenState();
}

class _EjecterDetailScreenState extends State<EjecterDetailScreen> {
  final mobileAdd =
