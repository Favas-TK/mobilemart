...
class OTGDetailScreen extends StatefulWidget {
  OTGDetailScreen({
    super.key,
  ...
  @override
  State<OTGDetailScreen> createState() => _OTGDetailScreenState();
}

class _OTGDetailScreenState extends State<OTGDetailScreen> {
  final mobileAdd =
