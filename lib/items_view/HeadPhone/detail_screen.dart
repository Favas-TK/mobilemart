...
class HeadphoneDetailScreen extends StatefulWidget {
  HeadphoneDetailScreen({
    super.key,
  ...
  @override
  State<HeadphoneDetailScreen> createState() => _HeadphoneDetailScreenState();
}

class _HeadphoneDetailScreenState extends State<HeadphoneDetailScreen> {
  final mobileAdd =
