...
class AddBTSpeaker extends StatefulWidget {
  const AddBTSpeaker({super.key});

  @override
  State<AddBTSpeaker> createState() => _AddBTSpeakerState();
}

class _AddBTSpeakerState extends State<AddBTSpeaker> {
  late final XFile? image;

  final itemAdd =
      FirebaseFirestore.instance.collection('BT_speaker_Collection');

  final auth = FirebaseAuth.instance;

  final itemDetails = InformationAddBloc();

  TextEditingController btSpeakerName = TextEditingController();

  TextEditingController btSpeakerPrice = TextEditingController();

  TextEditingController btSpeakerDescription = TextEditingController();

  TextEditingController btSpeakerCount = TextEditingController();
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomTextFieldWidget(
                      hintText: 'BT Speaker Name',
                      controller: btSpeakerName,
                    ),
                    space10,
                    CustomTextFieldWidget(
                      controller: btSpeakerDescription,
                      hintText: 'Enter BT Speaker Description',
                    ),
                    space10,
                    CustomTextFieldWidget(
                      controller: btSpeakerPrice,
                      hintText: 'Enter BT Speaker Price',
                    ),
                    space10,
                    CustomTextFieldWidget(
                      controller: btSpeakerCount,
                      hintText: 'Enter BT Speaker count',
                    ),
                    space10,
                    Container(
                            ...
                            child: CustomElevatedBtnWidget(
                              ...
                              onpressed: () => itemDetails.add(
                                AddDetailEvent(
                                  ...
                                  price: btSpeakerPrice.text,
                                  count: btSpeakerCount.text,
                                ),
                              ),
                              btnColor: blulight,
                              btnTextColor: white,
