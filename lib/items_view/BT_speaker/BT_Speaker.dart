...
import 'package:mobilemart/items_view/BT_speaker/add_speaker.dart';
import 'package:mobilemart/items_view/BT_speaker/detail_screen.dart';


class BTSpeakerPage extends StatelessWidget {
  BTSpeakerPage({super.key});
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => const AddBTSpeaker(),
            ),
          );
        },
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute<dynamic>(
                          builder: (context) =>
                              SpeakerDetailScreen(itemAxis: itemhome[index]),
                        ),
                      );
                    },
                    child: Padding(
