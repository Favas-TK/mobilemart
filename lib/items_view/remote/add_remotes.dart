...
class AddRemotes extends StatefulWidget {
  const AddRemotes({super.key});

  @override
  State<AddRemotes> createState() => _AddRemotesState();
}

class _AddRemotesState extends State<AddRemotes> {
  ...
  TextEditingController remoteName = TextEditingController();

  TextEditingController remotePrice = TextEditingController();

  TextEditingController remoteDescription = TextEditingController();

  TextEditingController remoteCount = TextEditingController();
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    space10,
                    CustomTextFieldWidget(
                      controller: remoteDescription,
                      hintText: 'Enter remote Description',
                    ),
                    space10,
                    CustomTextFieldWidget(
                      controller: remotePrice,
                      hintText: 'Enter remote Price',
                    ),
                    space10,
                    CustomTextFieldWidget(
                      controller: remoteCount,
                      hintText: 'Enter remote count',
                    ),
                    space10,
                    Container(
                            ...
                            child: CustomElevatedBtnWidget(
                              ...
                              onpressed: () => itemDetails.add(
                                RemoteAddDetailEvent(
                                  ...
                                  price: remotePrice.text,
                                  count: remoteCount.text,
                                ),
                              ),
                              btnColor: blulight,
                              btnTextColor: white,
