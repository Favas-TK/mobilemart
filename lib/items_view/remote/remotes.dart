...
import 'package:mobilemart/items_view/remote/add_remotes.dart';
import 'package:mobilemart/items_view/remote/detail_screen.dart';


class RemotePage extends StatelessWidget {
  RemotePage({super.key});
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(
              builder: (context) => const AddRemotes(),
            ),
          );
        },
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute<dynamic>(
                          builder: (context) =>
                              RemoteDetailScreen(itemAxis: itemhome[index]),
                        ),
                      );
                    },
                    child: Padding(
