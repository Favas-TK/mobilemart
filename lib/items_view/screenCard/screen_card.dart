...
import 'package:mobilemart/items_view/screenCard/add_screen_card.dart';
import 'package:mobilemart/items_view/screenCard/detail_screen.dart';


class ScreenCardPage extends StatelessWidget {
  ScreenCardPage({super.key});
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(
              builder: (context) => const AddScreenCard(),
            ),
          );
        },
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute<dynamic>(
                          builder: (context) =>
                              ScreenCardDetailScreen(itemAxis: itemhome[index]),
                        ),
                      );
                    },
                    child: Padding(
