...
import 'package:mobilemart/items_view/reader/add_reader.dart';
import 'package:mobilemart/items_view/reader/detail_screen.dart';
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(
              builder: (context) => const AddReader(),
            ),
          );
        },
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute<dynamic>(
                          builder: (context) =>
                              ReaderDetailScreen(itemAxis: itemhome[index]),
                        ),
                      );
                    },
                    child: Padding(
