...
class MouseDetailScreen extends StatefulWidget {
  MouseDetailScreen({
    super.key,
  ...
  @override
  State<MouseDetailScreen> createState() => _MouseDetailScreenState();
}

class _MouseDetailScreenState extends State<MouseDetailScreen> {
  final mobileAdd =
