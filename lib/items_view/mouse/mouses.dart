...
import 'package:mobilemart/items_view/mouse/add_mouses.dart';
import 'package:mobilemart/items_view/mouse/detail_screen.dart';
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(
              builder: (context) => const AddMouses(),
            ),
          );
        },
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute<dynamic>(
                          builder: (context) =>
                              MouseDetailScreen(itemAxis: itemhome[index]),
                        ),
                      );
                    },
                    child: Padding(
