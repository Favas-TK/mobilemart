...
class PouchDetailScreen extends StatefulWidget {
  PouchDetailScreen({
    super.key,
  ...
  @override
  State<PouchDetailScreen> createState() => _PouchDetailScreenState();
}

class _PouchDetailScreenState extends State<PouchDetailScreen> {
  final mobileAdd =
