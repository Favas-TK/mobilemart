...
class USBDetailScreen extends StatefulWidget {
  USBDetailScreen({
    super.key,
  ...
  @override
  State<USBDetailScreen> createState() => _USBDetailScreenState();
}

class _USBDetailScreenState extends State<USBDetailScreen> {
  final mobileAdd =
